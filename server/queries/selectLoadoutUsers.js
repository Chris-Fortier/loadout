...
// test: http://localhost:3060/api/v1/loadout-users?loadoutId=42655170-7e10-4431-8d98-c2774f6414a4
module.exports = function selectLoadoutUsers(loadoutId) {
   return `
      SELECT
         users.email,
